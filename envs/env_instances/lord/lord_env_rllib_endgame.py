...
LastEditTime: 2022-08-26 16:42:58
LastEditors: hanyu
Description: lord game environment
FilePath: /RL_Lab/envs/env_instances/lord/lord_env_rllib_endgame.py
'''
import gym
...
class LordEnv(gym.Env):
    ...
    def reset_auto_step(self):
        def check_condition():
            for _, hand in self.infoset.all_handcards.items():
                if len(hand) <= 8:
                    return True
            return False
